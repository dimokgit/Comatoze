...
namespace MarkSecurities.Controllers
{
    ...
    builder.EntitySet<vIsAAA>("DmitrivIsAAAs");
    config.Routes.MapODataServiceRoute("odata", "odata", builder.GetEdmModel());
    */
    public class DmitrivIsAAAsController : ODataController
    {
        private MarkSecuritiesModelEx db = new MarkSecuritiesModelEx();

        // GET: odata/DmitrivIsAAAs
        [EnableQuery]
        public IQueryable<vIsAAA> GetDmitrivIsAAAs()
        {
            return db.vIsAAAs;
        }

        // GET: odata/DmitrivIsAAAs(5)
        [EnableQuery]
